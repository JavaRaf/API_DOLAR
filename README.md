...
3. **Postar no Facebook**: A imagem gerada é postada na sua pagina do Facebook, com uma mensagem que inclui a data e a hora da postagem.
4. **Log das operações**: As informações sobre a cotação e o ID do post no Facebook são salvas em arquivos de log.


## Licença
Este projeto está sob a licença MIT. Veja o arquivo [LICENSE](LICESE.md) para mais detalhes.
